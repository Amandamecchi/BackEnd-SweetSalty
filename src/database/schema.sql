...
INSERT INTO receitas (nome_receita, ingredientes, modo_preparo, image_url, data_criacao, editar_receita)
VALUES (
    'Bolo de Chocolate',
    ...
    'https://meusite.com/imagens/bolo-chocolate.jpg',
    NOW(),
    FALSE
);
...
VALUES (
    ...
    'https://meusite.com/imagens/lasanha-carne.jpg',
    NOW(),
    TRUE
);
...
VALUES (
    ...
    'https://meusite.com/imagens/salada-caesar.jpg',
    NOW(),
    FALSE
);
